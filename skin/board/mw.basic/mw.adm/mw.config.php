...
<div id="tabs-1" class="tabs"> <!-- 기본설정 -->
    ...
    <div class="cf_item">
	<div class="cf_title"> <input type=checkbox name=chk[cf_comment_level] value=1>&nbsp; 코멘트 조회권한 </div>
	<div class="cf_content">
...
-->
	...
	<div class="cf_content">
	    ...
	    <script> document.cf_form.cf_comment_secret_no.checked = '<?=$mw_basic[cf_comment_secret_no]?>'; </script>
	</div>
    </div>
...
<div id="tabs-5-2" class="tabs"> <!-- 이미지 -->
    ...
    <div class="cf_item">
	<div class="cf_title"> <input type=checkbox name=chk[cf_watermark_path] value=1>&nbsp; NoImage 파일경로</div>
	<div class="cf_content">
