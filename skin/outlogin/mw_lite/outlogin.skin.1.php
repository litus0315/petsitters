<?php
/**
 * Bechu-Outlogin Skin for Gnuboard5
 *
...
<!-- 로그인 전 외부로그인 시작 -->
<div id="mw-outlogin">
<form name="foutlogin" action="<?php echo $outlogin_action_url?>" method="post" onsubmit="return foutlogin_submit(document.foutlogin);" autocomplete="off">
<input type="hidden" name="url" value="<?php echo $outlogin_url?>">
<div class="box-outside">
<div class="box-inside">
    <div class="login-title"><strong><?php echo $config['cf_title']?></strong> 로그인</div>
    <input type="text" name="mb_id" id="mb_id" class="login-mb_id" value="" placeholder="ID">
    <input type="password" name="mb_password" id="mb_password" class="login-mb_password" value="" placeholder="Password">
    <input type="image"  class="login-button" src="<?php echo $outlogin_skin_url?>/img/outlogin_button.gif" align="absmiddle">
    <div class="login-auto"><input type="checkbox" name="auto_login" id="auto_login">자동</div>
    <div class="login-membership">
        <a href="<?php echo G5_BBS_URL?>/register.php"><strong>회원가입</strong></a> <span>|</span>
        <a href="<?php echo G5_BBS_URL ?>/password_lost.php" class="win_password_lost">아이디·비밀번호찾기</a>
    </div>
</div>
</div>
</form>
...
#mw-outlogin .login-mb_id { position:absolute; margin:25px 0 0 7px; padding:4px 0 0 3px; border:1px solid #d0e1f1; width:100px; height:15px; }
...
#mw-outlogin .login-mb_password { width:100px; height:15px; font-size:8pt; color:#7dacd8; }
